...
public class AirMapManager extends ViewGroupManager<AirMapView> {
  ...
  @ReactProp(name = "scrollGesturesEnabledDuringRotateOrZoom", defaultBoolean = false)
    public void setScrollGesturesEnabledDuringRotateOrZoom(AirMapView view, boolean scrollGesturesEnabledDuringRotateOrZoom) {
